...
/**
 * This is the item provider adapter for a {@link sc.stateChart.CompositeState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeStateItemProvider extends StateItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompositeState_element_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompositeState_element_feature", "_UI_CompositeState_type"),
				 StateChartPackage.Literals.COMPOSITE_STATE__ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StateChartPackage.Literals.COMPOSITE_STATE__ELEMENT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompositeState.class)) {
			case StateChartPackage.COMPOSITE_STATE__ELEMENT:
