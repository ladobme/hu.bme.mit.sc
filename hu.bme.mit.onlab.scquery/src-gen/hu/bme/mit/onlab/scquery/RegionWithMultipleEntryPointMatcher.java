...
public class RegionWithMultipleEntryPointMatcher extends BaseMatcher<RegionWithMultipleEntryPointMatch> {
   ...
   * 
   */
  public static RegionWithMultipleEntryPointMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    RegionWithMultipleEntryPointMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new RegionWithMultipleEntryPointMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(RegionWithMultipleEntryPointMatcher.class);
   ...
   */
  @Deprecated
  public RegionWithMultipleEntryPointMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public RegionWithMultipleEntryPointMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  protected RegionWithMultipleEntryPointMatch tupleToMatch(final Tuple t) {
    try {
    	return RegionWithMultipleEntryPointMatch.newMatch((sc.stateChart.Region) t.get(POSITION_NAME));
  ...
  protected RegionWithMultipleEntryPointMatch arrayToMatch(final Object[] match) {
    try {
    	return RegionWithMultipleEntryPointMatch.newMatch((sc.stateChart.Region) match[POSITION_NAME]);
    } catch(ClassCastException e) {
  ...
  protected RegionWithMultipleEntryPointMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return RegionWithMultipleEntryPointMatch.newMutableMatch((sc.stateChart.Region) match[POSITION_NAME]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<RegionWithMultipleEntryPointMatcher> querySpecification() throws IncQueryException {
