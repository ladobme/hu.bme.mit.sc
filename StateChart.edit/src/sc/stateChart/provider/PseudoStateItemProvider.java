...
/**
 * This is the item provider adapter for a {@link sc.stateChart.PseudoState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PseudoStateItemProvider extends VertexItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPseudoStateTypePropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Pseudo State Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPseudoStateTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PseudoState_PseudoStateType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PseudoState_PseudoStateType_feature", "_UI_PseudoState_type"),
				 StateChartPackage.Literals.PSEUDO_STATE__PSEUDO_STATE_TYPE,
				 true,
				 false,
				 false,
